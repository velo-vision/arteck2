...
?>
<div class="wrap">
	<h2><?php esc_html_e('One-click Install Demo Content','bs-smarty') ?></h2>
</div>
...
<br>
<a href="#" onclick="return false" data-url="<?php echo esc_url(admin_url('?bravo_do_import=1&package=light')) ?>" class="btn_bravo_do_import button button-primary"><?php esc_html_e('Import Light Version','bs-smarty')?></a>
<a href="#" onclick="return false" data-url="<?php echo esc_url(admin_url('?bravo_do_import=1&package=dark')) ?>" class="btn_bravo_do_import button button-primary"><?php esc_html_e('Import Dark Version','bs-smarty')?></a>
<div id="import_debug">
</div>
<style>
	#import_debug{
