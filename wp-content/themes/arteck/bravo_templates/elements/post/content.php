...
<div class="blog-img centered-column <?php echo esc_attr( $class ); ?>" <?php echo ($bg);?>>
	<?php if(get_post_format() or (!get_post_format() and has_post_thumbnail())){?>
	<div class="blog-date">
				...
				if ( ! empty( $gallery ) ) {
					...
					<div class="single-slider-v2"
						...
						<?php foreach ( $gallery as $key => $value ) {
							...
							echo '<a href="' . $url[0] . '" data-lightbox="blog-item3-images">'.$img.'</a>';
						} ?>
					...
					<div class="blog-img-detail-content">
						<div class="row">
							<div class="col-xxxl-12 col-xxxl-offset-0 col-md-8 col-md-offset-2">
								...
								<?php if($author=get_post_meta(get_the_ID(),'author_name',true)){echo '&copy; '.$author;} ?>
							</div>
						</div>
					</div>
				</div>
