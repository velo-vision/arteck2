...
<section id="">
	<div class="section-content">
		<div class="container">
			...
			<div id="portfolio2" class="portfolio-layout2 onscroll-animate">
				<?php
					while ( $query->have_posts() ) {
						$query->the_post();
						$term_class = '';
								...
								<div class="portfolio-img">
									...
									<div class="portfolio-img-detail">
										<div class="portfolio-img-detail-inner">
											<a class="portfolio-img-detail-content" href="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" data-lightbox="portfolio-images"><i class="fa fa-search"></i></a>
										</div>
									</div>
								</div>
								<div class="portfolio-item-info">
									<div class="portfolio-item-cat ht_898989">
										<?php the_terms( get_the_ID(), 'portfolio_cat', '', ',', '' ); ?>
									</div>
									<a class="popup-window-trigger" data-popup="#popup-portfolio-<?php echo get_the_ID(); ?>"><?php the_title();?></a>
								</div>
							</div>
						</article>
