		...
		<div class="container">
			...
			<div class="clearfix">
				...
				<ul id="isotope-filter-list2" class="pull-right filter-list-alt">
					...
					<li class="isotope-filter-button"><a href="#"><i class="fa fa-reorder"></i> <?php esc_html_e('Filter','bs-smarty')?></a></li>
			...
			<div id="portfolio2" class="portfolio-layout4 row row-clean">
				<?php
					while ( $query->have_posts() ) {
						$query->the_post();
						$term_class = '';
