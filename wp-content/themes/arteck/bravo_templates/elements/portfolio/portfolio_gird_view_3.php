	...
	<div class="section-content ">
		<div class="container">
			<div class="clearfix">
				...
				<div id="portfolio3" class="portfolio-layout6 row row-clean">
				<?php
					while ( $query->have_posts() ) {
						$query->the_post();
						$term_class = '';
						...
						<article class="col-xxxl-12-5 col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xs-12  portfolio-item <?php echo esc_attr( $term_class ) ?>">
									...
									<div class="portfolio-img-detail">
										<div class="portfolio-img-detail-inner">
											<div class="portfolio-img-detail-content">
												<div class="portfolio-item-cat portfolio-img-detail-hidden">
													<?php the_terms( get_the_ID(), 'portfolio_cat', '', ', ', '' ); ?>
												</div>
												<p class="portfolio-item-heading"><?php the_title();?></p>
