...
$config['nav_menus']=array(
    'primary' => esc_html__( 'Primary Navigation', 'bs-smarty' ),
);
...
$config['sidebars']=array(
    array(
        'name' => esc_html__( 'Blog Sidebar', 'bs-smarty' ),
        'id' => 'blog-sidebar',
        'description' => esc_html__( 'Widgets in this area will be shown on all blog page.', 'bs-smarty'),
