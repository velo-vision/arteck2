    ...
    function bravo_paging($query=false,$key='paged',$link=false)
    {
        ...
        <div class="pagination-full">
            <?php if($page>1){
                ...
                printf('<a class="pagination-prev" href="%s">%s</a>',$prev,esc_html__('Previous Page','bs-smarty'));
            }?>
            ...
            <?php if($page<$query->max_num_pages and $next=get_next_posts_page_link()){
                ...
                printf('<a class="pagination-next" href="%s">%s</a>',$next,esc_html__('Next Page','bs-smarty'));
            }?>
        </div>
...
if(!function_exists('bravo_default_thumbnail'))
{
    ...
    {
        $alt=esc_html__('Image Alt','bs-smarty');
