...
if (function_exists('vc_map')) {
    ...
    vc_map(array(
            "name"     =>esc_html__("Bravo Portfolio Gird", 'bs-smarty'),
            "base"     => "bravo_portfolio_gird",
            ...
            'params'   => array(
                ...
                array(
                    ...
                    "value"      => array(
                       esc_html__( 'Gird v1', 'bs-smarty' ) => 'view_1',
                       esc_html__( 'Gird v2', 'bs-smarty' ) => 'view_2',
                       esc_html__( 'Gird v3', 'bs-smarty' ) => 'view_3',
                       esc_html__( 'Gird v4', 'bs-smarty' ) => 'view_4',
                       esc_html__( 'Gird v5', 'bs-smarty' ) => 'view_5',
                    )
                ),
                array(
                    "type"        => "dropdown",
    ...
    if (!function_exists('bravo_portfolio_gird_func')) {
        function bravo_portfolio_gird_func($attr, $content = false)
        {
            ...
            $html = BravoTemplate::load_view('elements/portfolio/portfolio_gird_'.$attr
        ...
        bravo_reg_shortcode('bravo_portfolio_gird', 'bravo_portfolio_gird_func');
    }
}