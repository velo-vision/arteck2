    ...
    class BravoLoader
    {
        ...
        static function library($lib_name=false)
        {
            ...
            locate_template(array(
                self::$_appdir.'/libraries/'.$lib_name.'.php',
                self::$_sysdir.'/libraries/'.$lib_name.'.php',
            ),true);
        ...
        static function element($lib_name=false)
        {
            ...
            locate_template(array(
                self::$_appdir.'/elements/'.$lib_name.'.php',
                self::$_sysdir.'/elements/'.$lib_name.'.php',
            ),true);
        ...
        static function widget($lib_name=false)
        {
            ...
            locate_template(array(
                self::$_appdir.'/widgets/'.$lib_name.'.php',
                self::$_sysdir.'/widgets/'.$lib_name.'.php',
            ),true);
        ...
        static function helper($lib_name=false)
        {
            ...
            locate_template(array(
                self::$_appdir.'/helpers/'.$lib_name.'.php',
                self::$_sysdir.'/helpers/'.$lib_name.'.php',
            ),true);
        ...
        static function model($lib_name=false)
        {
            ...
            locate_template(array(
                self::$_appdir.'/models/'.$lib_name.'.php',
                self::$_sysdir.'/models/'.$lib_name.'.php',
            ),true);
