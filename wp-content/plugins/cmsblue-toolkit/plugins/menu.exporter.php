...
function bravo_show_menu_post_type_in_export_options() {
...
add_action( 'load-export.php', 'bravo_catch_menu_export' );
 ...
 */
function bravo_export_wp( $args = array() ) {
	global $wpdb, $post;
	...
	function bravo_wxr_nav_menu_item_terms_and_posts( &$post_ids ) {
		...
		foreach( $post_ids as $post_id ) {
			...
			if( ($type = get_post_meta( $post_id, '_menu_item_type', true ) ) == 'taxonomy' ) {
				...
				wxr_term_name( $term );
				echo "</wp:term>\n";
			} elseif( $type == 'post_type' && in_array( get_post_meta( $post_id, '_menu_item_object', true ), array( 'post', 'page' , 'portfolio' ) ) ) {
...
<?php bravo_wxr_nav_menu_item_terms_and_posts( $post_ids ) ?>
