    ...
    class BravoImporter
{
    ...
    static $_import_page='themes.php?page=bravo_importer';
    static $_import_url='';
    ...
    static function _add_import_js()
    {
        ...
        if($screen->base=='appearance_page_bravo_importer' or $screen->base=='theme-settings_page_bravo_importer'){
            wp_enqueue_script('bravo_importer_js',self::$_url.'/js/import.js');

            wp_localize_script('jquery','bravo_importer',array(
                'admin_url'=>admin_url(),
                'loading_src'=>self::$_url.'/images/wpspin_light.gif'
            ));
        }
    }
    static function _add_sub_menu()
    {
        ...
        add_submenu_page(apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ),__('One-click Install Demo Content',CMSBLUETOOLKIT),__('One-click Install',CMSBLUETOOLKIT),'manage_options','bravo_importer',array(__CLASS__,'_show_import_page'));


    }
    static function _show_import_page()
    {
        $file=locate_template('bravo_templates/import.php');
