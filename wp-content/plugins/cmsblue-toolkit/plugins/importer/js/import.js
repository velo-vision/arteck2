...
jQuery(document).ready(function($){
   ...
   $('.btn_bravo_do_import').click(function(){
       ...
       if(comf == true){
           import_debug.show().html('Working ... <br><img class="loading_import" src="'+bravo_importer.loading_src+'">');
                   ...
                   success:function(html){
                       if(html){
                           if(html.status == 1){
                               ...
                               import_debug.append('<img class="loading_import" src="'+bravo_importer.loading_src+'">')
                           }
