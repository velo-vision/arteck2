...
?>
<div class="wrap">
    <h2><?php _e('One-click Install Demo Content',CMSBLUETOOLKIT) ?></h2>
</div>
...
<br>
    <a href="#" onclick="return false" data-url="<?php echo admin_url('?bravo_do_import=1') ?>" class="btn_bravo_do_import button button-primary"><?php _e('Import Now',CMSBLUETOOLKIT)?></a>
<div id="import_debug">
</div>
<style>
    #import_debug{
